...
void i2c_writeBit(uint8_t followerAddress, uint8_t targetAddress, uint8_t bit_n, uint8_t data);
void i2c_writeBits(uint8_t followerAddress, uint8_t targetAddress, uint8_t start_bit, uint8_t len, uint8_t data);
